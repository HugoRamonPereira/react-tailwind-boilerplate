    ...
    return (
      <div className='relative'>
        <input
          ...
          placeholder=' '
          className={cn(
            'bg-white w-full font-light rounded-lg border border-gray-500 pl-3 pr-12 h-[52px] mb-2 text-gray-800 pt-4 peer placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none',
